...
<template>
    <header class="sticky top-0 z-50 w-full bg-purple-950 shadow-lg">
        ...
        <div v-if="mobileMenuOpen" class="border-t border-purple-800 md:hidden">
            <nav class="container mx-auto px-4 py-4">
                ...
                <ul v-else class="space-y-2">
                    <template v-if="currentRole === 'client'">
                        <li>
                            <NuxtLink to="/home" @click="closeMobileMenu"
                                class="block rounded-lg px-4 py-3 text-sm font-medium text-white transition hover:bg-purple-800"
                                active-class="bg-purple-800">
                                Buscar Maestros
                            </NuxtLink>
                    ...
                    <template v-else-if="currentRole === 'master'">
                        <li>
                            <NuxtLink to="/master/dashboard" @click="closeMobileMenu"
                                class="block rounded-lg px-4 py-3 text-sm font-medium text-white transition hover:bg-purple-800"
                                active-class="bg-purple-800">
                                Dashboard
                            </NuxtLink>
                        ...
                        <li>
                            <NuxtLink to="/master/services" @click="closeMobileMenu"
                                class="block rounded-lg px-4 py-3 text-sm font-medium text-white transition hover:bg-purple-800"
                                active-class="bg-purple-800">
                                Mis Servicios
                            </NuxtLink>
                        ...
                        <li>
                            <NuxtLink to="/master/messages" @click="closeMobileMenu"
                                class="block rounded-lg px-4 py-3 text-sm font-medium text-white transition hover:bg-purple-800"
                                active-class="bg-purple-800">
                                Mensajes
                            </NuxtLink>
                        ...
                        <li>
                            <NuxtLink to="/master/profile" @click="closeMobileMenu"
                                class="block rounded-lg px-4 py-3 text-sm font-medium text-white transition hover:bg-purple-800"
                                active-class="bg-purple-800">
                                Mi Perfil
                            </NuxtLink>
