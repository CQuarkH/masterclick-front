...
<template>
  <div class="min-h-screen bg-linear-to-b from-gray-50 to-white w-full transition-all duration-300">
    <!-- Loading State -->
    ...
    <!-- Master Details -->
    <div v-else-if="master" class="relative w-full container mx-auto md:px-4 md:py-8 sm:px-0 sm:py-0 lg:px-8">
      <!-- Back Button -->
      <NuxtLink to="/home"
        class="absolute top-8 z-10 left-4 md:static mb-6 md:mt-0 sm:mt-10  inline-flex items-center gap-2 text-sm font-medium md:text-gray-600 text-white transition hover:text-purple-600">
      ...
      <div class="grid gap-8 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
          <!-- Header Card -->
          <div class="overflow-hidden lg:rounded-2xl md:rounded-2xl sm:rounded-none bg-white shadow-lg">
            <div class="relative h-48 bg-linear-to-br from-purple-950 to-purple-800">
              <div class="absolute -bottom-16 left-6 sm:left-8">
                <div class="relative">
                  <img :src="master.image" :alt="`Foto de ${master.name}`"
            ...
            <div class="relative md:static px-6 pb-6 pt-20 sm:px-8">
              ...
              <a href="#contact"
                class="absolute right-6 top-22 bg-purple-700 text-white px-4 py-2 rounded-lg shadow hover:bg-purple-800 transition md:hidden">
                Contactar
              </a>
              ...
              <div v-if="master.services && master.services.length > 0">
                ...
                <div class="flex flex-wrap gap-2">
                  <span v-for="(service, index) in master.services" :key="index"
        ...
        <div id="contact" class="space-y-6">
          ...
          <!-- Quick Info Card -->
          <div class="rounded-2xl bg-linear-to-br from-purple-50 to-blue-50 p-6 shadow-sm">
