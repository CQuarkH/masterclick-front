      ...
      <div class="grid gap-8 lg:grid-cols-3">
          ...
          <div class="overflow-hidden rounded-2xl bg-white shadow-lg">
            <div class="relative h-32 bg-gradient-to-br from-purple-950 to-purple-800">
              <div class="absolute -bottom-16 left-6 sm:left-8">
                <div class="relative">
                  <div class="flex h-32 w-32 items-center justify-center rounded-full border-4 border-white bg-purple-600 text-4xl font-bold text-white shadow-xl">
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-2xl bg-gradient-to-br from-purple-50 to-blue-50 p-6 shadow-sm">
            ...
            <div class="space-y-3">
              <button class="flex w-full items-center justify-between text-sm text-gray-700 transition hover:text-purple-600">
